...
function Contract(props) {
  ...
  var contractContent = ` This Agreement of Background Verifications made and executed at Bangalore on this 11 February 2022 Between`+ formState.companyname +` [CIN: `+ formState.cin +`], a company registered under the Companies Act, 1956, having registered office `+ formState.address +` (hereinafter referred to as the “Company” which expression shall, unless it be repugnant to the context or meaning there of shall be deemed to mean and include its successors, affiliates or assigns of the Other part,  (which terms shall unless repugnant to the context includes its successors in interest herein after referred to as the First Party;
  AND
  ...
  *Educational Reimbursement Cost: The cost / charged paid to universities / colleges will be reimbursed at actuals and proof will be submitted to OPPO Mobiles
  ...
  I hereby authorize `+ formState.companyname +` (name of the employer) (or a third-party agent appointed by the Company) to contact any former employers as indicated above and carry out all background checks, not restricted to education and employment, as deemed appropriate through this selection procedure. 
  ...
  I also authorize `+ formState.companyname +` (name of the employer) to share/provide a reference check covering my services with the Company to any third party/agency conducting a reference check on behalf of an employer/agency. This authorization survives any cessation of service/training with the Company.`
    return (
        <>
          <FormControl as="textarea" style={{ fontSize:13 }} rows={15} disabled readOnly placeholder={contractContent}>              
            </FormControl>
                </>
            )   
        }
